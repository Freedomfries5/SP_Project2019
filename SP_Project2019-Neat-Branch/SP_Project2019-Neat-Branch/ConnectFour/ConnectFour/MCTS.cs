...
namespace ConnectFour
{
    class MCTS
    {
        ...
        private Node expand(Node selectedNode)
        {
            ...
            Console.WriteLine(width+", "+ unvisitedChildrenIndices.Count+", "+ unvisitedChildrenIndices.Capacity);
            Console.WriteLine();
            Console.WriteLine(rnd.Next(0, unvisitedChildrenIndices.Capacity));
            Console.WriteLine();
            int selectedIndex = unvisitedChildrenIndices[(rnd.Next(1,unvisitedChildrenIndices.Count))];
